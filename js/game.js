...
class PokeFuryGame {
    ...
    selectGym(index) {
        ...
        const typeCircleOffsets = {
            ...
            'Fighting': { top: 'calc(15% - 190px)', left: 10, size: 120 },
            ...
            'Bug': { top: 'calc(13% - 130px)', left: 0, size: 120 },
            'Ghost': { top: 'calc(10% + 40px)', left: 0, size: 120 },
            'Dragon': { top: 'calc(12% - 70px)', left: 0, size: 120 },
            'Dark': { top: 'calc(14% + 10px)', left: 0, size: 120 },
            'Steel': { top: 'calc(11% - 90px)', left: 0, size: 120 },
            'Fairy': { top: 'calc(10% + 10px)', left: 0, size: 120 },
            'Normal': { top: 'calc(12% - 130px)', left: 40, size: 120 }
        };
