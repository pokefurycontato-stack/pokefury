...
export const ABILITY_EFFECTS = {
    ...
    'pixilate': { trigger: 'normal_convert', type: 'fairy', multiplier: 1.2 },
    'refrigerate': { trigger: 'normal_convert', type: 'ice', multiplier: 1.2 },
    ...
    'flash fire': { trigger: 'type_immune', types: ['fire'] },
    'storm drain': { trigger: 'type_immune', types: ['water'] },
    'earth eater': { trigger: 'type_immune', types: ['ground'] },
    'water bubble': { trigger: 'status_immune', statuses: [STATUS.BURN] },
    'purifying salt': { trigger: 'status_immune', statuses: [STATUS.BURN, STATUS.POISON, STATUS.TOXIC, STATUS.PARALYSIS, STATUS.SLEEP, STATUS.FREEZE] },
